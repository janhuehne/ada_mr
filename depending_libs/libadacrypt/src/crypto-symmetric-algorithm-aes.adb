...
package body Crypto.Symmetric.Algorithm.AES is
   ...
   begin
      Build_Encrypt_Key(Key, Words(Cipherkey.Encrypt_Key), Nk=> Nk128);
   ...
   begin
      Build_Encrypt_Key(Key, Words(Cipherkey.Encrypt_Key), Nk=> Nk192);
      Build_Decrypt_Key(Words(Cipherkey.Encrypt_Key),
                        Words(Cipherkey.Decrypt_Key));
   end Prepare_Key192;
   ...
   begin
      Build_Encrypt_Key(Key, Words(Cipherkey.Encrypt_Key),
                              Nk=> Nk256);
      Build_Decrypt_Key(Words(Cipherkey.Encrypt_Key),
                        Words(Cipherkey.Decrypt_Key));
   end Prepare_Key256;
