...
package body Crypto.Types.Elliptic_Curves.Zp.Database is
	...
	procedure Get_Elliptic_Curve(ECZ: out Elliptic_Curve_Zp; ECP: out EC_Point; order: out Big_Unsigned; length: in Bit_Length) is
	temp 			: Precomputed_Elliptic_Curve;
	temp_length : Bit_Length;
	cofactor 	: Big_Unsigned;
	LEN_EX 		: exception;
	begin
