...
--         end loop;
   ...
   begin
      ...
      declare
         ...
         Temp : D_Mod_Types:=(others => 0);
         R : Natural := Amount mod Mod_Type'Size;
         L : Natural := Mod_Type'Size-R;
         M : Natural := Amount/Mod_Type'Size;
      begin
...
--         end loop;
   ...
   function To_Bytes(X : Big_Unsigned) return Bytes is
      L : constant Natural := Length_In_Bytes(X)-1;
      M : constant Natural := (Mod_Type'Size / Byte'Size) - 1;
