...
package body Crypto.Symmetric.Algorithm.Tripledes.Oneway is
   ...
   begin
      -- Build an EDE-key
      Build_Encrypt_Key(Key( 0.. 7), Cipherkey(0)); -- E
      Build_Decrypt_Key(Key( 8..15), Cipherkey(1)); -- D
      Build_Encrypt_Key(Key(16..23), Cipherkey(2)); -- E
      ...
      begin
         Obsolete_Build_Encrypt_Key(Key( 0.. 7), Cipherkey(0));
         Obsolete_Build_Encrypt_Key(Key( 8..15), Cipherkey(1));
         Obsolete_Build_Encrypt_Key(Key(16..23), Cipherkey(2));
