...
package body Crypto.Symmetric.Algorithm.Serpent is
   ...
   function Encrypt (W : in Roundkey_Serpent256; Plaintext : in B_Block128)
      ...
      X0, X1, X2, X3 : Word;
   begin
      X0 := R_To_Word(Plaintext( 0 ..  3));
      X1 := R_To_Word(Plaintext( 4 ..  7));
      X2 := R_To_Word(Plaintext( 8 .. 11));
      X3 := R_To_Word(Plaintext(12 .. 15));
   ...
   function Decrypt (W : in Roundkey_Serpent256; Ciphertext :  in B_Block128)
      ...
      X0, X1, X2, X3 : Word;
   begin
      X0 := R_To_Word(Ciphertext( 0 ..  3));
      X1 := R_To_Word(Ciphertext( 4 ..  7));
      X2 := R_To_Word(Ciphertext( 8 .. 11));
      X3 := R_To_Word(Ciphertext(12 .. 15));
