...
package body Pi_Job is
  ...
  begin
    ...
    exception
      when others => Pairs_Per_Map_Process := 300000;
    end;
    ...
    for N in 1 .. Number_Of_Jobs loop
      declare
        The_Job : Job;
      begin
        The_Job.Random_Inital_Value := Natural(Rand_Int.Random(G));
        The_Job.Pairs_Per_Map_Process := Pairs_Per_Map_Process;
