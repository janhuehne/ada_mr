...
generic
  ...
  with function Find_Worker_By_Access_Token_And_Type(Access_Token : String; W_Type : Application_Helper.Worker_Type) return Master_Helper.Worker_Record_Access;
